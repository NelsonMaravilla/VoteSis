...
echo"<input type='hidden' name='candidatura_v' value='1'>";
		$queryss = "SELECT * FROM voto_persona WHERE dui='$dui_userp' AND tipo_candidatura='1' AND ano='$anio'";
...
<div class="row">
    <div class="col-md-6 text-center">
         <h4>CONCEJOS MUNICIPALES<br /><small><?php echo n_municipio($muni_userp);?></h4>
    </div>
    <div class="col-md-6 text-center">
...
<!-- mostrar papeleta -->
<?php
$mostrar_candidatos = "SELECT * FROM candidato WHERE tipo_candidatura='1' AND id_municipio='$muni_userp'";
$resul_candidatos = mysql_query($mostrar_candidatos);
	...
	for($cd = 0; $cd < mysql_num_rows($resul_candidatos); $cd++)
			...
			if($coalicion == 0)
			{
						$candidatosA = "SELECT * FROM candidato WHERE tipo_candidatura='1' AND id_municipio='$muni_userp'";
