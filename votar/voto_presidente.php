...
echo"<input type='hidden' name='candidatura_v' value='3'>";
		$queryss = "SELECT * FROM voto_persona WHERE dui='$dui_userp' AND tipo_candidatura='3' AND ano='$anio_acti'";
...
<div class="row">
    <div class="col-md-6 text-center">
         <h4>PRESIDENTE y VICE PRESIDENTE<br /></h4>
    </div>
    <div class="col-md-6 text-center">
...
<!-- mostrar papeleta -->
<?php
$mostrar_candidatos = "SELECT * FROM candidato WHERE tipo_candidatura='3' AND id_anoe='$anio_acti'";
$resul_candidatos = mysql_query($mostrar_candidatos);
	...
	for($cd = 0; $cd < mysql_num_rows($resul_candidatos); $cd++)
			...
			if($coalicion == 0)
			{
						$candidatosA = "SELECT * FROM candidato WHERE tipo_candidatura='3' AND id_anoe='$anio_acti'";
